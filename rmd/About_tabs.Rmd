...
for (i in state_list) {
  assign(i, ifelse(i == state, TRUE, FALSE))
}
...
#   assign(i, ifelse(i == category, TRUE, FALSE))
# }
...
```{r sample_collection, results='asis', include = params$nutrient}
...
```{r nutrients, results='asis', include = params$nutrient}

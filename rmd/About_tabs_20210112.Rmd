...
category_list <- c("physical", "nutrient")
...
More information about this monitoring program can be found on the <a href = "https://www.nps.gov/im/netn/water-quality-quantity-monitoring.htm">NETN Water Quality and Quantity Website</a>. Additional resources can be found in the <a href = https://irma.nps.gov/DataStore/Reference/Profile/2190885">NETN Lake, Pond, & Stream Monitoring Program in the Data Store</a> (Reference 2190885), including the latest <a href = "https://irma.nps.gov/DataStore/Reference/Profile/2229872">monitoring protocol, <a href = "https://irma.nps.gov/DataStore/SavedSearch/Profile/1456">summary reports</a>, and <a href  = "https://irma.nps.gov/DataStore/SavedSearch/Profile/1269>resource briefs</a>. If you have questions about the program or this report, please contact <a href = "mailto:Bill_Gawley@nps.gov">Bill Gawley</a>, NETN Physical Scientist.

<h3>Additional Resources</h3>
Gawley WG and Others. 2015. <a href="https://irma.nps.gov/DataStore/Reference/Profile/2229872">Northeast Temperate Network lakes, ponds, and streams monitoring protocol: 2015 revision.</a> Natural Resource Report. NPS/NETN/NRR—2016/1225. National Park Service. Fort Collins, Colorado
...
```{r sample_collection, results='asis', include = nutrient}
# include water sample collection if nutrient summary

htmltools::withTags(body(
      h3("Water Sample Collection"), p("Stream water is collected by submerging the sample bottle directly in the centroid of the streamflow with a gloved hand. Samples are analyzed for Acid Neutralizing Capacity (ANC), total phosphorus (TP), total nitrogen (TN), and dissolved organic carbon (DOC)."),
...
<details open><summary><h2>Metrics</h2></summary>

```{r physical, results='asis', include = physical}
...
```{r nutrients, results='asis', include = nutrient}
...
# classify parks by ecoregion, turn tables on and off?

...
comp_plots_p <- purrr::map2(char_list_p_comp, legend_list_p,
                ...
                set_names(char_list_p_comp) #name plots to refer to them by char name
...
comp_plots_p_final <- comp_plots_p_final  |>  layout(legend = list(x = 0, y = -0.25, orientation = "h"))
```
...
# Move legend down slightly and make it horizontal
comp_plots_n_final <- comp_plots_n_final |> layout(legend = list(x = 0, y = -0.25, orientation = "h"))
```

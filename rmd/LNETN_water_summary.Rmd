...
# (potentially need error handling here; it breaks if there is no data for target year)
...
show_comp_n <- ifelse(show_comp == TRUE & params$nutrient == TRUE, TRUE, FALSE)
```
...
if(params$nutrient==TRUE) {cat(as.character(fig_cap_n))}
```
...
for(i in seq_along(site_list)){
  ...
  num_plots_n <- ifelse(exists("plot_list_n") & params$nutrient == TRUE, 
  ...
  # Nutrient subplot
  subplots_n <- if(params$nutrient == TRUE & exists("plot_list_n")){
